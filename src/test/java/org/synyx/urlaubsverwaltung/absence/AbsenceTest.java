...
class AbsenceTest {
    ...
    void ensureCanBeInstantiatedWithCorrectProperties() {
        ...
        final Absence absence = new Absence(person, period, absenceTimeConfiguration);
    ...
    void ensureCorrectEventSubjectForHolidayReplacement() {
        ...
        final Absence absence = new Absence(person, period, absenceTimeConfiguration, HOLIDAY_REPLACEMENT);
