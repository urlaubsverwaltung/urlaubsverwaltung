...
public class AbsenceTest {
    ...
    public void ensureCanBeInstantiatedWithCorrectProperties() {
        ...
        Assert.assertEquals("Wrong start date", start.atStartOfDay(clock.getZone()), absence.getStartDate());
        Assert.assertEquals("Wrong end date", end.atStartOfDay(clock.getZone()).plusDays(1), absence.getEndDate());
    ...
    public void ensureThrowsOnNullConfiguration() {
        ...
        Period period = new Period(LocalDate.now(clock.getZone()), LocalDate.now(clock.getZone()), DayLength.FULL);
