...
class AbsenceServiceImplTest {
    ...
    void ensureVacationWithEmptyWorkingTimeFallsBackToSystemDefaultFederalState() {
        ...
        when(applicationService.getForStatesAndPerson(any(), any(), any(), any())).thenReturn(List.of(application));
        when(publicHolidaysService.getPublicHoliday(any(), eq(GERMANY_BERLIN))).thenReturn(Optional.of(new PublicHoliday(start, DayLength.ZERO, "")));
    ...
    void ensureVacationConsidersWorkingTimeOfPerson() {
        ...
        when(applicationService.getForStatesAndPerson(any(), any(), any(), any())).thenReturn(List.of(application));
        when(publicHolidaysService.getPublicHoliday(any(), eq(GERMANY_BADEN_WUERTTEMBERG))).thenReturn(Optional.of(new PublicHoliday(start, DayLength.ZERO, "")));
