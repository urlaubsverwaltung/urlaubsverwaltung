...
class AbsenceServiceImplTest {
    ...
    void ensureSickMorning() {
        ...
        assertThat(actualAbsences.get(0).getAbsenceRecords().get(0).getMorning().map(RecordInfo::getType)).hasValue(AbsencePeriod.Record.AbsenceType.SICK_NOTE);
        assertThat(actualAbsences.get(0).getAbsenceRecords().get(0).getNoon()).isEmpty();
    }
    ...
    void ensureSickNoon() {
        ...
        assertThat(actualAbsences.get(0).getAbsenceRecords().get(0).getNoon().map(RecordInfo::getType)).hasValue(AbsencePeriod.Record.AbsenceType.SICK_NOTE);
    }
    ...
    void ensureVacationMorningAndSickNoon() {
        ...
        assertThat(actualAbsences.get(1).getAbsenceRecords().get(0).getNoon().map(RecordInfo::getType)).hasValue(AbsencePeriod.Record.AbsenceType.SICK_NOTE);
    }
