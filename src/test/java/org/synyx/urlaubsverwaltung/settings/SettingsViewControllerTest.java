...
class SettingsViewControllerTest {
    ...
    @BeforeEach
    void setUp() {
        sut = new SettingsViewController(new WorkingTimeProperties(), settingsService, vacationTypeService, CALENDAR_PROVIDER_LIST, settingsValidator, clock,  specialLeaveService);
    }
