...
class SickNoteMailServiceTest {
    ...
    void ensureSendEndOfSickPayNotification() {
        ...
        assertThat(mails.get(0).getMailAddressRecipients()).contains(sickNoteA.getPerson());
        ...
        assertThat(mails.get(2).getMailAddressRecipients()).contains(sickNoteB.getPerson());
        ...
        assertThat(mails.get(3).getMailNotificationRecipients()).isEqualTo(NOTIFICATION_OFFICE);
