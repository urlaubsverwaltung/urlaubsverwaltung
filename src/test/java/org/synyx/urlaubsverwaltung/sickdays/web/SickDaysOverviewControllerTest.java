...
public class SickDaysOverviewControllerTest {

    private SickDaysOverviewController sut;
    ...
    @Before
    public void setUp() {
        sut = new SickDaysOverviewController(sickNoteService, personService, calendarService);
    }
