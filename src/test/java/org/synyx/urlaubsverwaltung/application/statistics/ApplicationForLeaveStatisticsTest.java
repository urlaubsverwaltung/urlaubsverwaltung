...
class ApplicationForLeaveStatisticsTest {
    ...
    void ensureReturnsDefaultValuesForNotUsedVacationType() {
        ...
        final ApplicationForLeaveStatistics statistics = new ApplicationForLeaveStatistics(person, null);
    ...
    void ensureCanSetTotalLeftOvertime() {
        final Person person = new Person("muster", "Muster", "Marlene", "muster@example.org");
        ApplicationForLeaveStatistics statistics = new ApplicationForLeaveStatistics(person, null);
    ...
    void ensureReturnsOptionalEmptyForMissingPersonBasedata() {
        final ApplicationForLeaveStatistics applicationForLeaveStatistics = new ApplicationForLeaveStatistics(null, null);
