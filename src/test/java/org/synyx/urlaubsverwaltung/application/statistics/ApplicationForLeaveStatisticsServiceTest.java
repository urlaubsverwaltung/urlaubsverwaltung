...
class ApplicationForLeaveStatisticsServiceTest {
    ...
    class GetStatisticsSortedByPerson {
        ...
        void ensureUsingAllActivePersonsForRequestingUserWithRole(Role role) {
            ...
            assertThat(actual.getContent().getFirst().getPerson()).isEqualTo(person);
        }
        ...
        void ensureUsingManagedMembersOfRequestingUserWithRole(Role role) {
            ...
            assertThat(actual.getContent()).hasSize(1);
            assertThat(actual.getContent().getFirst().getPerson()).isEqualTo(member);
        }
        ...
        void ensureStatisticsAreSortedByPerson() {
            ...
            assertThat(actualStatistics.getFirst().getPerson()).isEqualTo(anja);
    ...
    class GetStatisticsSortedByStatistics {
        ...
        void ensureAllActivePersonsAreRequestedWhenSortedByStatisticsAttributeByDepartmentPrivileged(final Role role) {
            ...
            assertThat(statisticsPage.getContent().getFirst().getPerson()).isEqualTo(departmentMemberTwo);
            assertThat(statisticsPage.getContent().getFirst().getLeftVacationDaysForYear()).isEqualTo(BigDecimal.ZERO);
