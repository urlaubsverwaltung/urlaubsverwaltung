...
class CalculationServiceTest {
    ...
    void testCheckApplicationDifferentYearAndEnoughDaysLeftArePositiveEditing() {
        ...
        final LocalDate validTo = LocalDate.of(2012, DECEMBER, 31);
        final LocalDate expiryDate = LocalDate.of(2012, APRIL, 1);
        final Optional<Account> account = Optional.of(new Account(person, validFrom, validTo, true, expiryDate, TEN, TEN, TEN, "comment"));
        ...
        final Optional<Account> accountNextYear = Optional.of(new Account(person, validFromNextYear, validToNextYear, true, expiryDateNextYear, TEN, TEN, TEN, "comment"));
    ...
    void testCheckApplicationOneDayIsToMuch() {
        ...
        final LocalDate validTo = LocalDate.of(2012, DECEMBER, 31);
        final LocalDate expiryDate = LocalDate.of(2012, APRIL, 1);
        final Optional<Account> account2012 = Optional.of(new Account(person, validFrom, validTo, true, expiryDate, TEN, TEN, TEN, "comment"));
        ...
        final Optional<Account> account2013 = Optional.of(new Account(person, validFrom13, validTo13, true, expiryDate13, TEN, TEN, TEN, "comment"));
        when(accountService.getHolidaysAccount(2013, person)).thenReturn(account2013);
    ...
    void testCheckApplicationOneDayIsNotOkayOverAYear() {
        ...
        final Optional<Account> account2013 = Optional.of(new Account(person, validFrom13, validTo13, true, expireDate13, TEN, TEN, TEN, "comment"));
        when(accountService.getHolidaysAccount(2013, person)).thenReturn(account2013);
    ...
    void testCheckApplicationNextYearUsingRemainingAlready() {
        ...
        final Optional<Account> account2012 = Optional.of(new Account(person, validFrom12, lastDayOfYear12, true, expireDate12, TEN, ZERO, ZERO, ""));
        when(accountService.getHolidaysAccount(2012, person)).thenReturn(account2012);
        ...
        final LocalDate expireDate13 = LocalDate.of(2013, APRIL, 1);
        final Optional<Account> account2013 = Optional.of(new Account(person, validFrom13, lastDayOfYear13, true, expireDate13, TEN, TEN, TEN, ""));
    ...
    private void prepareSetupWith10DayAnnualVacation(Person person, int usedDaysbeforeExpiryDate, int usedDaysAfterApril) {
        ...
        final LocalDate validTo13 = LocalDate.of(2013, DECEMBER, 31);
        final LocalDate expireDate13 = LocalDate.of(2013, APRIL, 1);
        final Account account13 = new Account(person, validFrom13, validTo13, true, expireDate13, TEN, TEN, TEN, "comment");
        ...
        final Account account14 = new Account(person, validFrom14, validTo14, true, expireDate14, TEN, TEN, TEN, "comment");
