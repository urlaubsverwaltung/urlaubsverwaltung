...
class ApplicationMailServiceTest {
    ...
    void ensureSendsAllowedNotificationToManagementAndColleague() {
        ...
        assertThat(mails.get(2).getSubjectMessageKey()).isEqualTo("subject.absence.allowed.to_colleagues");
    ...
    void sendConfirmationAllowedDirectly() {
        ...
        assertThat(mails.get(1).getSubjectMessageKey()).isEqualTo("subject.absence.allowed.to_colleagues");
    ...
    void sendCancelledDirectlyConfirmationByApplicant() {
        ...
        assertThat(mails.get(0).getTemplateModel()).isEqualTo(model);
        assertThat(mails.get(1).getMailAddressRecipients()).hasValue(List.of(colleague));
        assertThat(mails.get(1).getSubjectMessageKey()).isEqualTo("subject.absence.cancellation.to_colleagues");
