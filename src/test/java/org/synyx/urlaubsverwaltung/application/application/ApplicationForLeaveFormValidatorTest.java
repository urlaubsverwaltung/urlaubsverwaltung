...
class ApplicationForLeaveFormValidatorTest {
    ...
    void setUp() {
        ...
        appForm.setVacationType(new VacationType(1, true, HOLIDAY, "message_key", true, "#FACC15"));
    ...
    void ensureReasonIsNotMandatoryForUnpaidLeave() {
        ...
        final VacationType vacationType = new VacationType(1, true, UNPAIDLEAVE, "message_key", true, "#FACC15");
        appForm.setVacationType(vacationType);
        appForm.setReason("");
    ...
    void ensureReasonIsNotMandatoryForOvertime() {
        ...
        final VacationType vacationType = new VacationType(1, true, OVERTIME, "message_key", true, "#FACC15");
    ...
    void ensureReasonIsMandatoryForSpecialLeave() {
        ...
        final VacationType vacationType = new VacationType(1, true, SPECIALLEAVE, "message_key", true, "#FACC15");
    ...
    void ensureHoursIsMandatoryForOvertime() {
        ...
        appForm.setVacationType(new VacationType(1, true, OVERTIME, "message_key", true, "#FACC15"));
    ...
    void ensureHoursIsNotMandatoryForOtherTypesOfVacation() {
        ...
        VacationType holiday = new VacationType(1, true, HOLIDAY, "message_key", true, "#FACC15");
        ;
        VacationType specialLeave = new VacationType(1, true, SPECIALLEAVE, "message_key", true, "#FACC15");
        ;
        VacationType unpaidLeave = new VacationType(1, true, UNPAIDLEAVE, "message_key", true, "#FACC15");
        ;
    ...
    void ensureHoursCanNotBeZeroIfNoMinutesAreSet() {
        ...
        final VacationType overtimeVacationType = new VacationType(1, true, OVERTIME, "message_key", true, "#FACC15");
    ...
    void ensureOvertimeIsNotValidatedForApplicationForLeave() {
        ...
        final VacationType holidayVacationType = new VacationType(1, true, HOLIDAY, "message_key", true, "#FACC15");
    ...
    private static ApplicationForLeaveForm.Builder appFormBuilderWithDefaults() {
        return new ApplicationForLeaveForm.Builder()
            ...
            .vacationType(new VacationType(1, true, HOLIDAY, "message_key", true, "#FACC15"))
