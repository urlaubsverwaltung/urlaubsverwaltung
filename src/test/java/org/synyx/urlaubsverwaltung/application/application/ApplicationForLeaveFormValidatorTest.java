...
class ApplicationForLeaveFormValidatorTest {
    ...
    void setUp() {
        ...
        appForm.setVacationType(new VacationType(1, true, HOLIDAY, "message_key", true, true, YELLOW, false));
    ...
    void ensureReasonIsNotMandatoryForUnpaidLeave() {
        ...
        final VacationType vacationType = new VacationType(1, true, UNPAIDLEAVE, "message_key", true, true, YELLOW, false);
        appForm.setVacationType(vacationType);
        appForm.setReason("");
    ...
    void ensureReasonIsNotMandatoryForOvertime() {
        ...
        final VacationType vacationType = new VacationType(1, true, OVERTIME, "message_key", true, true, YELLOW, false);
    ...
    void ensureReasonIsMandatoryForSpecialLeave() {
        ...
        final VacationType vacationType = new VacationType(1, true, SPECIALLEAVE, "message_key", true, true, YELLOW, false);
    ...
    void ensureHoursIsMandatoryForOvertime() {
        ...
        appForm.setVacationType(new VacationType(1, true, OVERTIME, "message_key", true, true, YELLOW, false));
    ...
    void ensureHoursIsNotMandatoryForOtherTypesOfVacation() {
        ...
        VacationType holiday = new VacationType(1, true, HOLIDAY, "message_key", true, true, YELLOW, false);
        VacationType specialLeave = new VacationType(1, true, SPECIALLEAVE, "message_key", true, true, YELLOW, false);
        VacationType unpaidLeave = new VacationType(1, true, UNPAIDLEAVE, "message_key", true, true, YELLOW, false);
        ;
    ...
    void ensureHoursCanNotBeZeroIfNoMinutesAreSet() {
        ...
        final VacationType overtimeVacationType = new VacationType(1, true, OVERTIME, "message_key", true, true, YELLOW, false);
    ...
    void ensureOvertimeIsNotValidatedForApplicationForLeave() {
        ...
        final VacationType holidayVacationType = new VacationType(1, true, HOLIDAY, "message_key", true, true, YELLOW, false);
    ...
    private static ApplicationForLeaveForm.Builder appFormBuilderWithDefaults() {
        return new ApplicationForLeaveForm.Builder()
            ...
            .vacationType(new VacationType(1, true, HOLIDAY, "message_key", true, true, YELLOW, false))
