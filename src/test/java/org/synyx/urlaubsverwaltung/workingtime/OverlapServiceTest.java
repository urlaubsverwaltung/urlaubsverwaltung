...
public class OverlapServiceTest {
    ...
    public void ensureNoOverlappingIfOnlyInactiveApplicationsForLeaveInThePeriod() {
        ...
        Instant startDate = Instant.from(LocalDate.of(2012, JANUARY, 16));
        Instant endDate = Instant.from(LocalDate.of(2012, JANUARY, 18));
        ...
        when(applicationDAO.getApplicationsForACertainTimeAndPerson(any(Instant.class),
    ...
    public void ensureFullyOverlappingIfTheApplicationForLeaveToCheckIsFullyInThePeriodOfOtherApplicationsForLeave() {
        ...
        waitingApplication.setStartDate(Instant.from(LocalDate.of(2012, JANUARY, 16)));
        waitingApplication.setEndDate(Instant.from(LocalDate.of(2012, JANUARY, 18)));
        ...
        allowedApplication.setStartDate(Instant.from(LocalDate.of(2012, JANUARY, 19)));
        allowedApplication.setEndDate(Instant.from(LocalDate.of(2012, JANUARY, 20)));
        ...
        applicationToCheck.setDayLength(DayLength.FULL);
        applicationToCheck.setStartDate(Instant.from(LocalDate.of(2012, JANUARY, 18)));
        applicationToCheck.setEndDate(Instant.from(LocalDate.of(2012, JANUARY, 19)));
    ...
    public void ensurePartlyOverlappingIfTheApplicationForLeaveToCheckOverlapsOnlyStartOfPeriodOfOtherApplicationsForLeave() {
        ...
        Application applicationToCheck = TestDataCreator.anyApplication();
        applicationToCheck.setDayLength(DayLength.FULL);
        applicationToCheck.setStartDate(Instant.from(LocalDate.of(2012, JANUARY, 14)));
        applicationToCheck.setEndDate(Instant.from(LocalDate.of(2012, JANUARY, 16)));
    ...
    public void ensurePartlyOverlappingIfTheApplicationForLeaveToCheckOverlapsOnlyEndOfPeriodOfOtherApplicationsForLeave() {
        ...
        Application allowedApplication = new Application();
        allowedApplication.setDayLength(DayLength.FULL);
        allowedApplication.setStartDate(Instant.from(LocalDate.of(2012, JANUARY, 16)));
        allowedApplication.setEndDate(Instant.from(LocalDate.of(2012, JANUARY, 18)));
        allowedApplication.setStatus(ApplicationStatus.ALLOWED);
        ...
        applicationToCheck.setDayLength(DayLength.FULL);
        applicationToCheck.setStartDate(Instant.from(LocalDate.of(2012, JANUARY, 18)));
        applicationToCheck.setEndDate(Instant.from(LocalDate.of(2012, JANUARY, 20)));
    ...
    public void ensureNoOverlappingIfOnlyInactiveSickNotesInThePeriod() {
        ...
        when(sickNoteService.getByPersonAndPeriod(any(Person.class), any(Instant.class),
            any(Instant.class)))
        ...
        sickNote.setStartDate(Instant.from(LocalDate.of(2012, JANUARY, 16)));
        sickNote.setEndDate(Instant.from(LocalDate.of(2012, JANUARY, 18)));
    ...
    public void ensureFullyOverlappingIfTheApplicationForLeaveToCheckIsFullyInThePeriodOfASickNote() {
        ...
        sickNote.setDayLength(DayLength.FULL);
        sickNote.setStartDate(Instant.from(LocalDate.of(2012, JANUARY, 16)));
        sickNote.setEndDate(Instant.from(LocalDate.of(2012, JANUARY, 19)));
    ...
    public void ensureSickNoteCanBeEditedAndNoOverlappingErrorOccurs() {
        ...
        existentSickNote.setStartDate(Instant.from(LocalDate.of(2015, MARCH, 16)));
        existentSickNote.setEndDate(Instant.from(LocalDate.of(2015, MARCH, 16)));
        ...
        sickNote.setId(23);
        sickNote.setDayLength(DayLength.FULL);
        sickNote.setStartDate(Instant.from(LocalDate.of(2015, MARCH, 16)));
        sickNote.setEndDate(Instant.from(LocalDate.of(2015, MARCH, 17)));
        sickNote.setStatus(SickNoteStatus.ACTIVE);
    ...
    public void ensureNoOverlappingIfApplyingForTwoHalfDayVacationsOnTheSameDayButWithDifferentTimeOfDay() {
        ...
        Instant vacationDate = Instant.from(LocalDate.of(2012, JANUARY, 16));
        ...
        when(applicationDAO.getApplicationsForACertainTimeAndPerson(any(Instant.class), any(Instant.class), any(Person.class)))
