...
import static org.synyx.urlaubsverwaltung.settings.FederalState.*;
...
public class WorkingTimeControllerTest {
    ...
    public void setUp() {
        ...
        sut = new WorkingTimeController(personService, workingTimeService, settingsService, validator);
