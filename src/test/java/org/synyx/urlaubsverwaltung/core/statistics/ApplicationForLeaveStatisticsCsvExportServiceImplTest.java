...
public class ApplicationForLeaveStatisticsCsvExportServiceImplTest {
	...
	public void writeStatisticsForOnePersonFor2018() {
		FilterPeriod period = new FilterPeriod(java.util.Optional.ofNullable("01.01.2018"), java.util.Optional.ofNullable("31.12.2018"));
	...
	public void writeStatisticsForTwoPersonsFor2019() {
		FilterPeriod period = new FilterPeriod(java.util.Optional.ofNullable("01.01.2019"), java.util.Optional.ofNullable("31.12.2019"));
	...
	public void getFileNameForComplete2018() {
		...
		when(messageSource.getMessage("applications.statistics", new String[] { "Statistik" }, Locale.GERMAN)).thenReturn("test");
