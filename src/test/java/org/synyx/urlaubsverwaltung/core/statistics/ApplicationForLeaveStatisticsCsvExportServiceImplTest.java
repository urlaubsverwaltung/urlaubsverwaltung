...
public class ApplicationForLeaveStatisticsCsvExportServiceImplTest {
    ...
    public void writeStatisticsForOnePersonFor2018() {
        FilterPeriod period = new FilterPeriod(java.util.Optional.ofNullable("01.01.2018"),
    ...
    public void writeStatisticsForTwoPersonsFor2019() {
        FilterPeriod period = new FilterPeriod(java.util.Optional.ofNullable("01.01.2019"),
    ...
    private void mockMessageSource(final String key) {
