...
public class SickNoteCommentServiceTest {
    ...
    public void ensureCreatesACommentAndPersistsIt() {
        ...
        SickNoteComment comment = sickNoteCommentService.create(SickNoteStatus.EDITED, Optional.<String>absent(),
                author);
    ...
    public void ensureCreationOfCommentWithTextWorks() {
        ...
        SickNoteComment comment = sickNoteCommentService.create(SickNoteStatus.CONVERTED_TO_VACATION,
