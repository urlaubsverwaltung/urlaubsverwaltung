...
public class KontoServiceImplTest {
    ...
    public void testGetUrlaubsanspruch() {
        ...
        Mockito.when(urlaubsanspruchDAO.getUrlaubsanspruchByDate(Mockito.anyInt(), (Person) (Mockito.any())))
    ...
    public void testRollbackUrlaub() {
        ...
        Mockito.doNothing().when(spy).rollbackNoticeJanuary((Antrag) (Mockito.any()), (Urlaubskonto) (Mockito.any()),
            (Urlaubskonto) (Mockito.any()), Mockito.anyDouble(), Mockito.anyDouble());

        spy.rollbackUrlaub(antrag);

        // ks should call rollbacknoticejanuary
        Mockito.verify(spy).rollbackNoticeJanuary((Antrag) (Mockito.any()), (Urlaubskonto) (Mockito.any()),
            (Urlaubskonto) (Mockito.any()), Mockito.anyDouble(), Mockito.anyDouble());
        ...
        // Mockito.when(spy.getUrlaubsanspruch(Mockito.anyInt(), (Person)(Mockito.any()))).thenReturn(urlaubsanspruch);
        Mockito.doReturn(urlaubsanspruch).when(spy).getUrlaubsanspruch(Mockito.anyInt(), (Person) (Mockito.any()));
        Mockito.doNothing().when(spy).rollbackNoticeApril((Antrag) (Mockito.any()), (Urlaubskonto) (Mockito.any()),
            Mockito.anyDouble());
        spy.rollbackUrlaub(antrag);

        // ks should call rollbacknoticeapril
        Mockito.verify(spy).rollbackNoticeApril((Antrag) (Mockito.any()), (Urlaubskonto) (Mockito.any()),
            Mockito.anyDouble());
    }
