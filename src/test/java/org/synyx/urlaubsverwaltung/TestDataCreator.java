...
public final class TestDataCreator {
    ...
    public static List<VacationType> createVacationTypes() {
        ...
        final VacationType holidayType = new VacationType(1000, true, HOLIDAY, "application.data.vacationType.holiday");
        vacationTypes.add(holidayType);

        final VacationType specialLeaveType = new VacationType(2000, true, SPECIALLEAVE, "application.data.vacationType.specialleave");
        vacationTypes.add(specialLeaveType);

        final VacationType vacationType3 = new VacationType(3000, true, UNPAIDLEAVE, "application.data.vacationType.unpaidleave");
        vacationTypes.add(vacationType3);

        final VacationType vacationType4 = new VacationType(4000, true, OVERTIME, "application.data.vacationType.overtime");
