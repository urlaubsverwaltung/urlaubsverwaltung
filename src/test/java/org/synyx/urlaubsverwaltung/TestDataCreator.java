...
public final class TestDataCreator {
    ...
    public static List<VacationType> createVacationTypes() {
        ...
        final VacationType specialLeaveType = new VacationType(2000L, true, SPECIALLEAVE, "application.data.vacationType.specialleave", true, YELLOW, false);
        vacationTypes.add(specialLeaveType);

        final VacationType vacationType3 = new VacationType(3000L, true, UNPAIDLEAVE, "application.data.vacationType.unpaidleave", true, YELLOW, false);
        vacationTypes.add(vacationType3);

        final VacationType vacationType4 = new VacationType(4000L, true, OVERTIME, "application.data.vacationType.overtime", true, YELLOW, false);
