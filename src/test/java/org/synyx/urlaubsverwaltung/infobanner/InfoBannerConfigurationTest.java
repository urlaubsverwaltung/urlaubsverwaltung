...
class InfoBannerConfigurationTest {
    ...
    void ensureInfoBannerControllerAdviceExists() {
        contextRunner
            ...
            .run(context -> assertThat(context).hasSingleBean(InfoBannerControllerAdvice.class));
    }

    @Test
    void ensureInfoBannerControllerAdviceDoesNotExistWhenPropertyIsMissing() {
        contextRunner
            .run(context -> assertThat(context).doesNotHaveBean(InfoBannerControllerAdvice.class));
    }
