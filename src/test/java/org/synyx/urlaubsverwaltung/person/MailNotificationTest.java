...
class MailNotificationTest {
    ...
    @ParameterizedTest
    @EnumSource(value = Role.class, names = {"DEPARTMENT_HEAD", "SECOND_STAGE_AUTHORITY", "ADMIN", "INACTIVE", "APPLICATION_ADD", "APPLICATION_CANCEL", "APPLICATION_CANCELLATION_REQUESTED", "SICK_NOTE_VIEW", "SICK_NOTE_ADD", "SICK_NOTE_EDIT", "SICK_NOTE_CANCEL", "SICK_NOTE_COMMENT"})
    ...
    @ParameterizedTest
    @EnumSource(value = Role.class, names = {"ADMIN", "INACTIVE", "APPLICATION_ADD", "APPLICATION_CANCEL", "APPLICATION_CANCELLATION_REQUESTED", "SICK_NOTE_VIEW", "SICK_NOTE_ADD", "SICK_NOTE_EDIT", "SICK_NOTE_CANCEL", "SICK_NOTE_COMMENT"})
