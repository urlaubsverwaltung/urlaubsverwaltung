...
class OvertimeCommentDtoTest {
    ...
    void equals() {
        ...
        final OvertimeCommentPersonDto personDto = new OvertimeCommentPersonDto("niceName", "gravatarUrl");
        ...
        final OvertimeCommentPersonDto personDtoTwo = new OvertimeCommentPersonDto("niceNameDifferent", "gravatarUrl");
    ...
    void hashCodeTest() {
        ...
        assertThat(overtimeCommentDto.hashCode()).isEqualTo(-857088145);
    }
}
