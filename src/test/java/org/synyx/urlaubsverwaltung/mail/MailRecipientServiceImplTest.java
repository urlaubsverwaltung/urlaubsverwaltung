...
class MailRecipientServiceImplTest {
    ...
    class RecipientsOfInterestForSickNotesTest {
        ...
        void ensureToMapOfficesPersonsCorrectly() {
            ...
            office.setNotifications(List.of(NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT_TO_MANAGEMENT));
            when(personService.getActivePersonsByRole(OFFICE)).thenReturn(List.of(office));

            final List<Person> recipientsForSubmittedSickNotes = sut.getRecipientsOfInterestForSickNotes(normalUser, NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT_TO_MANAGEMENT);
        ...
        void ensureToNotMapBosses() {
            ...
            boss.setNotifications(List.of(NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT_TO_MANAGEMENT));
        ...
        @Test
        void getRecipientsOfInterestWithDepartmentsAndSickNoteAddFilteredByEnabledMailNotification() {
            ...
            departmentHeadWithSickNoteAdd.setNotifications(List.of(NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT_TO_MANAGEMENT));

            // given department head without sick note edit permission
            final Person departmentHeadWithoutSickNoteAdd = new Person("departmentHead", "departmentHead", "departmentHead", "departmentHead@example.org");
            departmentHeadWithoutSickNoteAdd.setId(6L);
            departmentHeadWithoutSickNoteAdd.setPermissions(List.of(USER, DEPARTMENT_HEAD));
            departmentHeadWithoutSickNoteAdd.setNotifications(List.of(NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT_TO_MANAGEMENT));
            ...
            secondStageWithSickNoteAdd.setNotifications(List.of(NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT_TO_MANAGEMENT));

            // given second stage without sick note edit permission
            final Person secondStageWithoutSickNoteAdd = new Person("secondStage", "secondStage", "secondStage", "secondStage@example.org");
            secondStageWithoutSickNoteAdd.setId(8L);
            secondStageWithoutSickNoteAdd.setPermissions(List.of(USER, SECOND_STAGE_AUTHORITY));
            secondStageWithoutSickNoteAdd.setNotifications(List.of(NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT_TO_MANAGEMENT));

            final Person secondStageWithoutMailNotification = new Person("secondStage", "secondStage", "secondStage", "secondStage@example.org");
            secondStageWithoutMailNotification.setId(9L);
            secondStageWithoutMailNotification.setPermissions(List.of(USER, SECOND_STAGE_AUTHORITY, SICK_NOTE_ADD));
            secondStageWithoutMailNotification.setNotifications(List.of());
            ...
            when(responsiblePersonService.getResponsibleSecondStageAuthorities(normalUser))
                .thenReturn(List.of(secondStageWithSickNoteAdd, secondStageWithoutSickNoteAdd, secondStageWithoutMailNotification));

            final PersonId bossAllId = new PersonId(office.getId());
            when(userNotificationSettingsService.findNotificationSettings(List.of(bossAllId)))
                .thenReturn(Map.of(bossAllId, new UserNotificationSettings(bossAllId, false)));

            final List<Person> recipientsForAllowAndRemind = sut.getRecipientsOfInterestForSickNotes(normalUser, NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT_TO_MANAGEMENT);
            assertThat(recipientsForAllowAndRemind)
                .doesNotContain(departmentHeadWithoutSickNoteAdd, secondStageWithoutSickNoteAdd, secondStageWithoutMailNotification)
                .containsOnly(office, departmentHeadWithSickNoteAdd, secondStageWithSickNoteAdd);
        }
        ...
        void getRecipientsOfInterestDoesNotReturnOfficePersonWhenNotGloballyInterestedAndNotSameDepartment() {
            ...
            officeAll.setId(3L);
            officeAll.setPermissions(List.of(USER, OFFICE));
            officeAll.setNotifications(List.of(NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT_TO_MANAGEMENT));
            when(personService.getActivePersonsByRole(OFFICE)).thenReturn(List.of(officeAll));
        ...
        void ensureToCallDatabaseForPersonsWithRoleIfNotificationIsValidForGivenRole(final Role role) {
            ...
            sut.getRecipientsOfInterestForSickNotes(normalUser, NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT_TO_MANAGEMENT);
            verify(personService).getActivePersonsByRole(role);
        }
