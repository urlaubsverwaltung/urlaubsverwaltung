...
public class ApplicationForLeaveStatisticsControllerTest {

    private ApplicationForLeaveStatisticsController sut;
    ...
    public void setUp() {
        ...
        sut = new ApplicationForLeaveStatisticsController(applicationForLeaveStatisticsService, applicationForLeaveStatisticsCsvExportService, vacationTypeService);
    }
