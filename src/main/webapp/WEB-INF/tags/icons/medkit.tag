<!---------------------------------------------
kudos
* https://fontawesome.com/icons/medkit (https://fontawesome.com/license)
---------------------------------------------->

<%@attribute name="className" type="java.lang.String" required="false" %>

<svg viewBox="0 0 512 512" fill="currentColor" width="16px" height="16px" class="${className}" role="img" aria-hidden="true" focusable="false">
