                        ...
                        >
                            <span class="tw-inline-flex tw-text-blue-200 dark:tw-text-sky-800">
                                <img
                                    ...
                                    alt=""
                                    class="gravatar tw-rounded-full tw-w-8 tw-h-8 lg:tw-w-9 lg:tw-h-9"
                                    width="52px"
                                    height="52px"
                                    data-fallback="<c:out value="${URL_PREFIX}/avatar?name=${userFirstName} ${userLastName}"/>"
                                    is="uv-avatar"
                                />
                            </span>
                                        ...
                                        >
                                            <span class="tw-inline-flex tw-text-blue-200 dark:tw-text-sky-800">
                                                <img
                                                    ...
                                                    width="64px"
                                                    height="64px"
                                                    data-fallback="<c:out value="${URL_PREFIX}/avatar?name=${userFirstName}"/>"
                                                    is="uv-avatar"
                                                />
                                            </span>
