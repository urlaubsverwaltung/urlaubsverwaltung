...
<tr class="odd">
    ...
    <td>
        <c:set var ="holidayDays" value="${usedDaysOverview.numberOfHolidayDays + 0}" />
            <c:choose>
...
<tr class="even">
    ...
    <td>
        <c:set var ="specialDays" value="${usedDaysOverview.numberOfSpecialLeaveDays + 0}" />
            <c:choose>
...
<tr class="odd">
    ...
    <td>
        <c:set var ="unpaidDays" value="${usedDaysOverview.numberOfUnpaidLeaveDays + 0}" />
            <c:choose>
...
<tr class="even">
    ...
    <td>
        <c:set var ="overtimeDays" value="${usedDaysOverview.numberOfOvertimeDays + 0}" />
            <c:choose>
...
<tr class="odd">
    ...
    <td style="border-top: 2px solid #D7D7D7">
        <c:set var ="allDays" value="${usedDaysOverview.numberOfHolidayDays + usedDaysOverview.numberOfSpecialLeaveDays + usedDaysOverview.numberOfUnpaidLeaveDays + usedDaysOverview.numberOfOvertimeDays}" />
            <c:choose>
