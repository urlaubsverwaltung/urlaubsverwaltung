...
<uv:section-heading>
    <jsp:attribute name="actions">
        <a href="${URL_PREFIX}/person/${person.id}${yearUrlParameterFirst}" class="icon-link tw-px-1" data-title="<spring:message code="action.account.title" arguments="${person.niceName}"/>">
