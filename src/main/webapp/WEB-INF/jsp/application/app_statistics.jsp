        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <c:choose>
                    ...
                    <c:otherwise>
                        <table id="application-statistic-table" class="list-table sortable tablesorter tw-text-sm">
                            ...
                            <c:forEach items="${statistics}" var="statistic">
                                <tr>
                                    ...
                                    <c:if test="${showPersonnelNumberColumn}">
                                        <td class="tw-hidden lg:tw-table-cell print:tw-table-cell tw-text-ellipsis tw-overflow-hidden tw-max-w-xs"><c:out value="${statistic.personnelNumber}"/></td>
                                    </c:if>
                                    ...
                                    <td class="tw-hidden md:tw-table-cell print:tw-table-cell" data-sortable-value="${statistic.leftVacationDays}">
                                        <strong>
