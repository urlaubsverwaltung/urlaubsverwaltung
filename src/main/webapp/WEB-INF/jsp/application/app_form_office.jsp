            ...
            <div class="container_12">
                <c:choose>
                    ...
                    <c:otherwise>    
                        ...
                        <form:form method="post" action="${formUrlPrefix}/${person.id}/application/new?force=${forcy}" modelAttribute="appForm"> 
                            ...
                            <div class="grid_6">
                                ...
                                <table class="app-detail" cellspacing="0">
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <select style="width:98%;" onchange="window.location.href=this.options
