...
<head>
    ...
    <uv:custom-head/>
    <link rel="stylesheet" href="<asset:url value='account_form~app_form~overtime_form~person_overview~sick_note_form.css' />" />
    <link rel="stylesheet" href="<asset:url value='account_form~app_form~overtime_form~sick_note_form.css' />" />
    <script>
        window.uv = {};
...
<%--    <script defer src="<asset:url value='date-fns-localized.js' />"></script>--%>
    ...
    <script defer src="<asset:url value='account_form~app_form~overtime_form~sick_note_form.js' />"></script>
