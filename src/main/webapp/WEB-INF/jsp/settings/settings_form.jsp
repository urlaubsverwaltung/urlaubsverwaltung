    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="form-section">
                ...
                <div class="col-md-8 col-md-pull-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="maximumAnnualVacationDays"><spring:message code='settings.vacation.maximumAnnualVacationDays'/></label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4" for="maximumMonthsToApplyForLeaveInAdvance"><spring:message code='settings.vacation.maximumMonthsToApplyForLeaveInAdvance'/></label>
                        <div class="col-md-8">
            ...
            <div class="form-section">
                ...
                <div class="col-md-8 col-md-pull-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="maximumSickPayDays"><spring:message code='settings.sickDays.maximumSickPayDays'/></label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4" for="daysBeforeEndOfSickPayNotification"><spring:message code='settings.sickDays.daysBeforeEndOfSickPayNotification'/></label>
                        <div class="col-md-8">
            ...
            <div class="form-section">
                ...
                <div class="col-md-8 col-md-pull-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="workingDurationForChristmasEve"><spring:message code='settings.publicHolidays.workingDuration.christmasEve'/></label>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4" for="workingDurationForNewYearsEve"><spring:message code='settings.publicHolidays.workingDuration.newYearsEve'/></label>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4" for="federalStateType"><spring:message code='settings.publicHolidays.federalState'/></label>
