                                    ...
                                    <tr data-enabled="${absenceType.active}">
                                        ...
                                        <td data-th-text="<spring:message code='settings.absenceTypes.table.head.color' />">
                                            ...
                                            <div class="tw-mt-2 tw-p-2 tw-rounded-md tw-border-gray-400 tw-border-2  tw-grid-flow-row-dense tw-grid-cols-3 tw-grid-rows-3 tw-gap-1" id="color-chooser-${loop.index}-popup" style="background-color:black; display: none">
                                                <label style="display:flex;"><input id="color-chooser-${loop.index}-radio-1" name="absenceTypeSettings.items[${loop.index}].color" class="tw-hidden" type="radio" value="#D4D4D4"><div style="background-color:#D4D4D4;" class="tw-w-8 tw-h-8 tw-rounded-md tw-cursor-pointer"></div></label>
                                                <label style="display:flex;"><input id="color-chooser-${loop.index}-radio-2" name="absenceTypeSettings.items[${loop.index}].color" class="tw-hidden" type="radio" value="#FCA5A5"><div style="background-color:#FCA5A5;" class="tw-w-8 tw-h-8 tw-rounded-md tw-cursor-pointer"></div></label>
                                                <label style="display:flex;"><input id="color-chooser-${loop.index}-radio-3" name="absenceTypeSettings.items[${loop.index}].color" class="tw-hidden" type="radio" value="#FDBA74"><div style="background-color:#FDBA74;" class="tw-w-8 tw-h-8 tw-rounded-md tw-cursor-pointer"></div></label>
                                                <label style="display:flex;"><input id="color-chooser-${loop.index}-radio-4" name="absenceTypeSettings.items[${loop.index}].color" class="tw-hidden" type="radio" value="#FDE047"><div style="background-color:#FDE047;" class="tw-w-8 tw-h-8 tw-rounded-md tw-cursor-pointer"></div></label>
                                                <label style="display:flex;"><input id="color-chooser-${loop.index}-radio-5" name="absenceTypeSettings.items[${loop.index}].color" class="tw-hidden" type="radio" value="#BEF264"><div style="background-color:#BEF264;" class="tw-w-8 tw-h-8 tw-rounded-md tw-cursor-pointer"></div></label>
                                                <label style="display:flex;"><input id="color-chooser-${loop.index}-radio-6" name="absenceTypeSettings.items[${loop.index}].color" class="tw-hidden" type="radio" value="#67E8F9"><div style="background-color:#67E8F9;" class="tw-w-8 tw-h-8 tw-rounded-md tw-cursor-pointer"></div></label>
                                                <label style="display:flex;"><input id="color-chooser-${loop.index}-radio-7" name="absenceTypeSettings.items[${loop.index}].color" class="tw-hidden" type="radio" value="#93C5FD"><div style="background-color:#93C5FD;" class="tw-w-8 tw-h-8 tw-rounded-md tw-cursor-pointer"></div></label>
                                                <label style="display:flex;"><input id="color-chooser-${loop.index}-radio-8" name="absenceTypeSettings.items[${loop.index}].color" class="tw-hidden" type="radio" value="#C4B5FD"><div style="background-color:#C4B5FD;" class="tw-w-8 tw-h-8 tw-rounded-md tw-cursor-pointer"></div></label>
                                                <label style="display:flex;"><input id="color-chooser-${loop.index}-radio-9" name="absenceTypeSettings.items[${loop.index}].color" class="tw-hidden" type="radio" value="#F0ABFC"><div style="background-color:#F0ABFC;" class="tw-w-8 tw-h-8 tw-rounded-md tw-cursor-pointer"></div></label>
                                            </div>
