        ...
        <c:forEach items="${absenceOverview.months}" var="month">
            <div class="tw-mb-10 print:tw-break-inside-avoid">
                ...
                >
                    <thead>
                        <tr>
                            <th scope="col" class="print:tw-hidden tw-cursor-default tw-p-2 tw-sticky tw--left-0.5 tw-bg-gradient-to-r tw-from-white dark:tw-from-trueGray-900 dark:tw-via-trueGray-900 tw-z-40">&nbsp;</th>
                    ...
                    <c:forEach var="person" items="${month.persons}">
                        <tr role="row">
                            <th
                                scope="row"
                                class="tw-p-0.5 print:tw-hidden tw-sticky tw--left-px tw-bg-gradient-to-r tw-from-white dark:tw-from-neutral-900 dark:tw-via-trueGray-900 tw-z-40 tw-border-l-0 tw-z-10"
                            >
                                <uv:avatar
