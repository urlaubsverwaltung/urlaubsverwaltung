...
deine Abwesenheit vom ${application.startDate.format("dd.MM.yyyy")} bis zum ${application.endDate.format("dd.MM.yyyy")} wurde von ${application.canceller.niceName} erfolgreich storniert.
