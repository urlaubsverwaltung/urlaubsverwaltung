...
<form:form method="POST" action="${URL_PREFIX}/staff/${person.id}/workingtime" modelAttribute="workingTime" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <form:select path="federalState" id="federalStateType" class="form-control"
                    ...
                    <form:option value=""><spring:message code="person.form.workingTime.federalState.default"
