...
<form:form id="convert" cssClass="form action-form confirm alert alert-success" method="POST"
    ...
    <div class="form-group">
        <div class="control-label">
            <c:choose>
                ...
                <c:otherwise>
                    <b><spring:message code='action.convert_to_sick.confirm'/></b>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <!-- TODO: add datepicker for choosing wich days of vacation have to be transformed to sick-notes -->
    ...
    <div class="form-group is-sticky row">
        ...
        <button type="button" class="btn btn-default col-xs-12 col-sm-5 pull-right" onclick="$('#convert').hide();">
