        ...
        <tr class="type-${comment.action}">
            ...
            <td>
                ...
                <c:choose>
                    ...
                    <c:when test="${comment.action == 'ALLOWED' || comment.action == 'TEMPORARY_ALLOWED' || comment.action == 'REJECTED' || comment.action == 'CONVERTED' || comment.action == 'CANCEL_REQUESTED'}">
