 ...
 * @param percentage                         {@code vacationDaysTaken} relative to {@code validEntitlement}, as a
 *                                            value between 0 and 100, {@link BigDecimal#ZERO} when the entitlement
 *                                            sum is zero
 * @param averageVacationDaysTakenPerPerson  {@code vacationDaysTaken} divided by the number of considered persons,
 *                                            {@link BigDecimal#ZERO} when there are none
...
record VacationDaysTakenResult(
    ...
    BigDecimal averageVacationDaysTakenPerPerson,
