...
class OvertimeMailService {
    ...
    void sendOvertimeNotificationToApplicantFromApplicant(OvertimeEntity overtime, OvertimeComment overtimeComment) {
    ...
    void sendOvertimeNotificationToApplicantFromManagement(OvertimeEntity overtime, OvertimeComment overtimeComment, Person author) {
    ...
    void sendOvertimeNotificationToManagement(OvertimeEntity overtime, OvertimeComment overtimeComment) {
