...
public class PersonCalendar extends AbstractTenantAwareEntity {
    ...
    @SequenceGenerator(name = "person_calendar_generator", sequenceName = "person_calendar_id_seq", allocationSize = 1)
    private Long id;
    ...
    public PersonCalendar(Person person, Period calendarPeriod, String secret) {
        this.person = person;
