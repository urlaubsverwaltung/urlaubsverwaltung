...
@Service
public class CalendarAbsenceServiceImpl implements CalendarAbsenceService {
    ...
    @Autowired
    public CalendarAbsenceServiceImpl(
    ...
    @Override
    public List<CalendarAbsence> getOpenAbsencesSince(List<Person> persons, LocalDate since) {
    ...
    @Override
    public List<CalendarAbsence> getOpenAbsencesSince(LocalDate since) {
