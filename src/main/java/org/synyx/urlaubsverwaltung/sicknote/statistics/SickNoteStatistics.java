    ...
    private List<BigDecimal> calculateTotalNumberOfSickDays(Year year, WorkDaysCountService workDaysCountService, List<SickNote> sickNotes, SickNoteCategory category) {
        ...
        for (Month month : Month.values()) {
            ...
            for (SickNote sickNote : sickNotes) {
                ...
                final boolean startIsSameMonth = sickNote.getStartDate().getMonth().equals(month);
                final boolean endIsSameMonth = sickNote.getEndDate().getMonth().equals(month);
                if (matchesCategory && (startIsSameMonth || endIsSameMonth)) {
