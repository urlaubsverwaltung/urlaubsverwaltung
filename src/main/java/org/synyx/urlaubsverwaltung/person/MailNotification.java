...
public enum MailNotification {
    ...
    NOTIFICATION_EMAIL_SICK_NOTE_SUBMITTED_BY_USER_TO_MANAGEMENT(true, hasRole(USER).and(hasAnyRole(OFFICE, SICK_NOTE_EDIT))),
    ...
    NOTIFICATION_EMAIL_SICK_NOTE_ACCEPTED_BY_MANAGEMENT_TO_MANAGEMENT(true, hasRole(USER).and(hasAnyRole(OFFICE, SICK_NOTE_EDIT))),
