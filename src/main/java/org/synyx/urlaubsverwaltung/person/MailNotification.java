...
public enum MailNotification {
    ...
    NOTIFICATION_EMAIL_APPLICATION_MANAGEMENT_APPLIED(true, false, hasRole(USER).and(hasAnyRole(BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))), // TODO and APPLICATION_ADD ?
    ...
    NOTIFICATION_EMAIL_APPLICATION_MANAGEMENT_CANCELLATION(true, false, hasRole(USER).and(hasAnyRole(BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))), // TODO and APPLICATION_CANCEL ?
    NOTIFICATION_EMAIL_APPLICATION_MANAGEMENT_EDITED(true, false, hasRole(USER).and(hasAnyRole(BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))), // TODO and APPLICATION_EDIT ?
