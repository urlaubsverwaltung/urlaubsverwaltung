...
public enum MailNotification {
    ...
    NOTIFICATION_EMAIL_SICK_NOTE_SUBMITTED_BY_USER_TO_USER(false, hasRole(USER)),
    NOTIFICATION_EMAIL_SICK_NOTE_SUBMITTED_BY_USER_TO_MANAGEMENT(true, hasRole(USER).and(hasAnyRole(OFFICE).or(hasRole(SICK_NOTE_ADD).and(hasAnyRole(BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))))),
    NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT(false, hasRole(USER)),
    NOTIFICATION_EMAIL_SICK_NOTE_CREATED_BY_MANAGEMENT_TO_MANAGEMENT(true, hasRole(USER).and(hasRole(OFFICE).or(hasRole(SICK_NOTE_ADD).and(hasAnyRole(BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))))),
    NOTIFICATION_EMAIL_SICK_NOTE_ACCEPTED_BY_MANAGEMENT_TO_USER(false, hasRole(USER)),
    NOTIFICATION_EMAIL_SICK_NOTE_ACCEPTED_BY_MANAGEMENT_TO_MANAGEMENT(true, hasRole(USER).and(hasAnyRole(OFFICE).or(hasRole(SICK_NOTE_ADD).and(hasAnyRole(BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))))),
    NOTIFICATION_EMAIL_SICK_NOTE_EDITED_BY_MANAGEMENT(false, hasRole(USER)),
    NOTIFICATION_EMAIL_SICK_NOTE_CANCELLED_BY_MANAGEMENT(false, hasRole(USER)),
