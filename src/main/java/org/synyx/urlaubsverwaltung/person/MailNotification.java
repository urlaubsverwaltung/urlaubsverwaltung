...
public enum MailNotification {
    ...
    NOTIFICATION_EMAIL_APPLICATION_MANAGEMENT_APPLIED(true, false, hasRole(USER).and(hasAnyRole(OFFICE, BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))),
    NOTIFICATION_EMAIL_APPLICATION_MANAGEMENT_ALLOWED(true, false, hasRole(USER).and(hasAnyRole(OFFICE, BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))),
    NOTIFICATION_EMAIL_APPLICATION_MANAGEMENT_REVOKED(true, false, hasRole(USER).and(hasAnyRole(OFFICE, BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))),
    NOTIFICATION_EMAIL_APPLICATION_MANAGEMENT_REJECTED(true, false, hasRole(USER).and(hasAnyRole(OFFICE, BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))),
    NOTIFICATION_EMAIL_APPLICATION_MANAGEMENT_TEMPORARY_ALLOWED(true, false, hasRole(USER).and(hasAnyRole(OFFICE, BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))),
    NOTIFICATION_EMAIL_APPLICATION_MANAGEMENT_CANCELLATION(true, false, hasRole(USER).and(hasAnyRole(OFFICE, BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))),
    NOTIFICATION_EMAIL_APPLICATION_MANAGEMENT_EDITED(true, false, hasRole(USER).and(hasAnyRole(OFFICE, BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))),
    NOTIFICATION_EMAIL_APPLICATION_MANAGEMENT_CONVERTED(true, false, hasRole(USER).and(hasAnyRole(OFFICE, BOSS, DEPARTMENT_HEAD, SECOND_STAGE_AUTHORITY))),
