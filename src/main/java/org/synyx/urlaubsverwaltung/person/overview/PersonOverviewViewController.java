...
@Controller
@RequestMapping("/web")
public class PersonOverviewViewController {
    ...
    @Autowired
    PersonOverviewViewController(PersonService personService, AccountService accountService,
    ...
    @GetMapping("/person")
    public String getPersonOverview() {
        return "redirect:/web/person?active=true";
    }

    @PreAuthorize(IS_PRIVILEGED_USER)
    @GetMapping(value = "/person", params = "active")
    public String getPersonOverview(@RequestParam(value = "active") boolean active,
