...
public class CompanyVacationEventHandlerExtension {
    ...
    public CompanyVacationEventHandlerExtension(TenantSupplier tenantSupplier, ApplicationEventPublisher applicationEventPublisher) {
