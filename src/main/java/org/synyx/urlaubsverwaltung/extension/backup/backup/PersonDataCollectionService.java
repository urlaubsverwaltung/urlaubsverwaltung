...
class PersonDataCollectionService {
    ...
    List<PersonDTO> collectPersons(List<Person> persons) {
        return persons.stream().map(person -> {
            ...
            final UserNotificationSettingsDTO userNotificationSettingsDTO = new UserNotificationSettingsDTO(userNotificationSettingsService.findNotificationSettings(new PersonId(person.getId())).isRestrictToDepartments());
