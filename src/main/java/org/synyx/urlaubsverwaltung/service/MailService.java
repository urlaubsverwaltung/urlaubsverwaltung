...
public interface MailService {
    ...
    /**
     * this method sends to all persons of the list a notification, that there
     * resturlaub-days will be void very soon
     * @param persons the list of persons which should receive the mail
     */
    void sendDecayNotification(List<Person> persons);
    
    /**
     * this method sends to all persons of the first list a notification that there
     * are some new requests (and a few information about the requests maybe)
     * @param persons the list of persons which should receive the mail
    ...
    /**
     * this method sends a mail to stern@synyx.de mentioning all requests
     * in the list
     * @param requests  the requests to mention in the mail
     */
    void sendWeeklyVacationForecast(List<Antrag> requests);
    
    
    /**
     * this method sends a notification to a bunch of persons if a specified request
     * got canceled by the applicant
