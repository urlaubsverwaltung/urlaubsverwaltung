    ...
    function handleClick(event) {
      if (event.target.tagName === "A") {
        ...
        if (this[activeSymbol] !== clickedItem) {
          ...
          previousLink.classList.remove("tw:text-black-almost", "tw:dark:text-zinc-200");
          previousLink.classList.add("tw:text-zinc-400", "tw:dark:text-zinc-500");
          ...
          event.target.classList.add("tw:text-black-almost", "tw:dark:text-zinc-200");
          event.target.classList.remove("tw:text-zinc-400", "tw:dark:text-zinc-500");
