...
const View = (function () {
  ...
  function renderDay(date) {
    ...
    function style() {
      ...
      return [
        holidayService.hasHolidayFull(date) ? `--absence-bar-color:${colorMorningOrFull}` : ``,
        holidayService.hasHolidayMorning(date) ? `--absence-bar-color-morning:${colorMorningOrFull}` : ``,
        holidayService.hasHolidayNoon(date) ? `--absence-bar-color-noon:${colorNoon}` : ``,
