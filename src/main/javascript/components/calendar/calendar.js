...
const View = (function () {
  ...
  const TMPL = {
    ...
    day: '<li class="tw-border-b tw-border-r tw-border-white dark:tw-border-zinc-900" style="{{cellStyle}}"><button type="button" class="tw-w-full tw-border-none datepicker-day {{css}}" style="{{style}}" data-title="{{title}}" data-datepicker-date="{{date}}" data-datepicker-selectable="{{selectable}}" data-datepicker-has-any-absence="{{hasAnyAbsence}}">{{day}}<span class="tw-sr-only"> {{month}}</span>{{icon}}</button></li>',
