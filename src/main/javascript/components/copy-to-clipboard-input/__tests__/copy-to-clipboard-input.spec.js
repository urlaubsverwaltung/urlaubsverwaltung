...
describe("copy-to-clipboard-input", () => {
  ...
  test("renders", () => {
    ...
    expect(document.body.innerHTML).toBe(
      `<div is="uv-copy-to-clipboard-input" class="uv-input-group"><input type="text" tabindex="-1"><span class="uv-input-group-addon"><button class="button button--no-hover border-0 outline-hidden text-current bg-transparent" title="undefined" data-placement="bottom"><svg fill="none" viewBox="0 0 24 24" stroke="currentColor" width="16px" height="16px" class="w-4 h-4 stroke-2" role="img" aria-hidden="true" focusable="false"><path stroke-linecap="round" stroke-linejoin="round" d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m0 0h2a2 2 0 012 2v3m2 4H10m0 0l3-3m-3 3l3 3"></path></svg></button></span></div>`,
    );
  });
