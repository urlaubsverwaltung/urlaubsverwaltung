...
*/}}
{{- define "urlaubsverwaltung.fullname" -}}
...
*/}}
{{- define "urlaubsverwaltung.chart" -}}
...
Common labels
*/}}
{{- define "urlaubsverwaltung.labels" -}}
helm.sh/chart: {{ include "urlaubsverwaltung.chart" . }}
{{ include "urlaubsverwaltung.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "urlaubsverwaltung.selectorLabels" -}}
...
*/}}
{{- define "urlaubsverwaltung.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "urlaubsverwaltung.fullname" .) .Values.serviceAccount.name }}
{{- else }}
